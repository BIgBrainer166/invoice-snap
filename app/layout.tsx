...
export const metadata: Metadata = {
  ...
  description:
    "Simple, fast invoicing for freelancers. Create professional invoices in 90 seconds with no accounting complexity. Free forever plan available.",
  generator: "v0.app",
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.variable} ${poppins.variable} ${sourceSerif.variable} font-sans antialiased`}>
        {children}
        <Analytics />
      </body>
    </html>
